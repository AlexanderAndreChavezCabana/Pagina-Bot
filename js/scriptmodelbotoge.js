        ...
        window.addEventListener('dfMessengerLoaded', function (event) {
           ...
           //  div_microphone.textContent = "Ejemplo"; 
            ...
            btn_microphone.addEventListener('click',function(){
                ...
                if (speech == true) {
                    recognition.start();
                    btn_microphone.style = "display:block; height: 40px; width: 40px; border-radius: 50px; border: 0; margin-top: 5px; margin-bottom: 5px; background: llinear-gradient(135deg, rgb(37, 71, 106, 0.3) 0%, rgb(20, 105, 126, 0.3) 100%); ";
                }
